 ...
 **/
public class Retrofit2RxJavaGenerator extends Retrofit2AbstractGenerator {

    public Retrofit2RxJavaGenerator() {
        super("", "ForRxJava");
    }

    public Retrofit2RxJavaGenerator(String prefix, String suffix) {
        super(prefix, suffix);
    }

    public Retrofit2RxJavaGenerator(Collection<Class<? extends Converter.Factory>> converterFactories) {
        super(converterFactories);
    }

    public Retrofit2RxJavaGenerator(String prefix, String suffix, Collection<Class<? extends Converter.Factory>> converterFactories) {
        super(prefix, suffix, converterFactories);
    }

    public Retrofit2RxJavaGenerator(Modeler<ClassFragment> modeler) {
        super(modeler);
    }

    public Retrofit2RxJavaGenerator(Modeler<ClassFragment> modeler, String prefix, String suffix) {
        super(modeler, prefix, suffix);
    }

    public Retrofit2RxJavaGenerator(Modeler<ClassFragment> modeler, Collection<Class<? extends Converter.Factory>> converterFactories) {
        super(modeler, converterFactories);
    }

    public Retrofit2RxJavaGenerator(Modeler<ClassFragment> modeler, String prefix, String suffix, Collection<Class<? extends Converter.Factory>> converterFactories) {
