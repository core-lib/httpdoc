    ...
    public Model design(Archetype archetype) throws SchemaDesignException {
        ...
        switch (schema.getCategory()) {
            ...
            case OBJECT:
                ...
                clazz.setSuperclass(superclass != null && superclass.getCategory() == Category.OBJECT ? superclass.toType(pkgGenerated, pkgForced, provider) : null);
                ...
                for (Map.Entry<String, Property> entry : (properties != null ? properties.entrySet() : Collections.<Map.Entry<String, Property>>emptySet())) {
                    ...
                    HDType type = property.getType().toType(pkgGenerated, pkgForced, provider);
        ...
        return new BasicModel(clazz.getClazz().getName(), clazz, preference);
    }
