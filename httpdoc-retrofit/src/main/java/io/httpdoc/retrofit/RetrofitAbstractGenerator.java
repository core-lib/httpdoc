...
public abstract class RetrofitAbstractGenerator extends ModelGenerator implements Generator {
    ...
    public void generate(Generation generation) throws IOException {
        ...
        generate(document, directory, pkg, pkgForced, supplier, controllers);
    }

    protected void generate(Document document, String directory, String pkgGenerated, boolean pkgForced, Supplier supplier, Set<Controller> controllers) throws IOException {
