...
public abstract class RetrofitAbstractGenerator extends ModelGenerator implements Generator {
    ...
    public void generate(Generation generation) throws IOException {
        ...
        generate(document, directory, pkg, pkgForced, provider, instanced, controllers);
    }
    ...
    protected void generate(Document document, String directory, String pkgGenerated, boolean pkgForced, Provider provider, boolean instanced, Set<Controller> controllers) throws IOException {
