...
public abstract class JestfulClientAbstractGenerator extends ModelGenerator implements Generator {
    ...
    public void generate(Generation generation) throws IOException {
        ...
        generate(directory, pkg, pkgForced, supplier, controllers);
    }

    protected void generate(String directory, String pkgGenerated, boolean pkgForced, Supplier supplier, Set<Controller> controllers) throws IOException {
