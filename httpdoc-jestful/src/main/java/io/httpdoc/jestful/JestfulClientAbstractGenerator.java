...
public abstract class JestfulClientAbstractGenerator extends ModelGenerator implements Generator {
    ...
    public void generate(Generation generation) throws IOException {
        ...
        boolean instanced = generation.isInstanced();
        generate(document, directory, pkg, instanced);
        generate(directory, pkg, pkgForced, provider, instanced, controllers);
    }

    protected void generate(Document document, String directory, String pkg, boolean instanced) throws IOException {
        if (instanced) {
    ...
    protected void generate(String directory, String pkgGenerated, boolean pkgForced, Provider provider, boolean instanced, Set<Controller> controllers) throws IOException {
        ...
        for (Controller controller : controllers) {
            ...
            interfase.setClazz(new HDClass(HDClass.Category.INTERFACE, pkg + "." + name));
            if (instanced) interfase.setSuperclass(new HDClass(HDClass.Category.INTERFACE, pkgGenerated + "." + "JestfulAPI"));
