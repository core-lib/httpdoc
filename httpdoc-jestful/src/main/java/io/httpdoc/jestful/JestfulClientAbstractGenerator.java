 ...
 **/
public abstract class JestfulClientAbstractGenerator extends SchemaGenerator implements Generator {
    ...
    public void generate(Generation generation) throws IOException {
        ...
        generate(directory, pkg, provider, controllers);
    }
    ...
    protected void generate(String directory, String pkg, Provider provider, Set<Controller> controllers) throws IOException {
