...
public class JestfulHeaderGenerator extends JestfulAbstractGenerator {
    ...
    public JestfulHeaderGenerator(Modeler<ClassFragment> modeler) {
        super(modeler);
    }
    ...
    public JestfulHeaderGenerator(Modeler<ClassFragment> modeler, String prefix, String suffix) {
    ...
    protected Collection<MethodFragment> generate(OperationGenerateContext context) {
        ...
        method.setResultFragment(new ResultFragment(HDType.valueOf(Header.class), result != null ? result.getDescription() : null));
