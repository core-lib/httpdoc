 ...
 **/
public class JestfulGuavaGenerator extends JestfulAbstractGenerator {

    public JestfulGuavaGenerator() {
        super("", "ForGuava");
    }
    ...
    public JestfulGuavaGenerator(String prefix, String suffix) {
        super(prefix, suffix);
    }
    ...
    protected Collection<MethodFragment> generate(OperationGenerateContext context) {
        ...
        HDParameterizedType returnType = new HDParameterizedType(HDType.valueOf(ListenableFuture.class), null, type != null ? type : HDType.valueOf(Entity.class));
