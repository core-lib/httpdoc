...
//                interfase.setName(prefix + name);
//                interfase.setCommentFragment(new CommentFragment(schema.getDescription() != null ? schema.getDescription() + "\n" + comment : comment));
//                interfase.setSuperclass((ObjCSchema) schema.getSuperclass());
...
//                    propertyFragment.setType((ObjCSchema) property.getType());
...
//        objectClassInArrayResult.setType(new ObjCSchema(prefix, Schema.valueOf(new ParameterizedTypeImpl(NSDictionary.class, new Class<?>[]{NSString.class, NSString.class}))));
